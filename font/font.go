...
var data = [][][]int8{
	...
	// 0x30
	'0': {{13, 14, 25, 65, 74, 72, 61, 21, 12, 13}, {35, 34, 52, 51}},
	'1': {{31, 13, 73}, {71, 75}},
	...
	'7': {{11, 15, 72}},
	'8': {{43, 42, 31, 21, 12, 14, 25, 35, 44, 42, 51, 61, 72, 74, 65, 55, 44, 43}},
	...
	'B': {{41, 44, 35, 25, 14, 11, 71, 74, 65, 55, 44, 43}},
	...
	'M': {{71, 11, 43, 15, 75}},
	'N': {{15, 75, 11, 71}},
	'O': {{13, 14, 25, 65, 74, 72, 61, 21, 12, 13}},

	// 0x50
	'P':  {{41, 44, 35, 25, 14, 11, 71}},
	'Q':  {{13, 14, 25, 65, 74, 72, 61, 21, 12, 13}, {63, 85}},
	...
	'n': {{71, 31, 34, 45, 75}},
	'o': {{33, 34, 45, 65, 74, 72, 61, 41, 32, 33}},
