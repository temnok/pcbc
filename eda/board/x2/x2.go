...
func X2(topLabel, bottomLabel string) *eda.Component {
	logo := pcbc.Logo.Arrange(transform.ScaleUniformly(0.7).Move(1.7, 1.35))
	firm := pcbc.Firm.Arrange(transform.ScaleUniformly(0.4).Move(1.7, -1.5))
	rev := pcbc.Rev(2025, 2, 19).Arrange(transform.RotateDegrees(90).ScaleUniformly(0.5).Move(4.6, 0))
